...
public class ListPopupWindow {
    ...
    class C01273 implements OnItemSelectedListener {
        C01273() {
        }
    ...
    class C05631 extends ForwardingListener {
        C05631(View x0) {
            super(x0);
        }
    ...
    private static class DropDownListView extends ListViewCompat {
        ...
        public DropDownListView(Context context, boolean hijackFocus) {
            super(context, null, C0103R.attr.dropDownListViewStyle);
    ...
    public ListPopupWindow(Context context) {
        this(context, null, C0103R.attr.listPopupWindowStyle);
    }

    public ListPopupWindow(Context context, AttributeSet attrs) {
        this(context, attrs, C0103R.attr.listPopupWindowStyle);
    }
    ...
    public ListPopupWindow(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0103R.styleable.ListPopupWindow, defStyleAttr, defStyleRes);
        this.mDropDownHorizontalOffset = a.getDimensionPixelOffset(C0103R.styleable.ListPopupWindow_android_dropDownHorizontalOffset, POSITION_PROMPT_ABOVE);
        this.mDropDownVerticalOffset = a.getDimensionPixelOffset(C0103R.styleable.ListPopupWindow_android_dropDownVerticalOffset, POSITION_PROMPT_ABOVE);
    ...
    private int buildDropDown() {
        ...
        if (this.mDropDownList == null) {
            ...
            this.mShowDropDownRunnable = new C01262();
            ...
            this.mDropDownList.setOnItemSelectedListener(new C01273());
