...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    class C05583 implements ViewPropertyAnimatorUpdateListener {
        C05583() {
        }
    ...
    class C08761 extends ViewPropertyAnimatorListenerAdapter {
        C08761() {
        }
    ...
    class C08772 extends ViewPropertyAnimatorListenerAdapter {
        C08772() {
        }
    ...
    public WindowDecorActionBar(Activity activity, boolean overlayMode) {
        ...
        this.mHideListener = new C08761();
        this.mShowListener = new C08772();
        this.mUpdateListener = new C05583();
    ...
    private void init(View decor) {
        this.mOverlayLayout = (ActionBarOverlayLayout) decor.findViewById(C0103R.id.decor_content_parent);
        if (this.mOverlayLayout != null) {
            this.mOverlayLayout.setActionBarVisibilityCallback(this);
        }
        this.mDecorToolbar = getDecorToolbar(decor.findViewById(C0103R.id.action_bar));
        this.mContextView = (ActionBarContextView) decor.findViewById(C0103R.id.action_context_bar);
        this.mContainerView = (ActionBarContainer) decor.findViewById(C0103R.id.action_bar_container);
        this.mSplitView = (ActionBarContainer) decor.findViewById(C0103R.id.split_action_bar);
        ...
        TypedArray a = this.mContext.obtainStyledAttributes(null, C0103R.styleable.ActionBar, C0103R.attr.actionBarStyle, CONTEXT_DISPLAY_NORMAL);
        if (a.getBoolean(C0103R.styleable.ActionBar_hideOnContentScroll, ALLOW_SHOW_HIDE_ANIMATIONS)) {
            setHideOnContentScrollEnabled(true);
        }
        int elevation = a.getDimensionPixelSize(C0103R.styleable.ActionBar_elevation, CONTEXT_DISPLAY_NORMAL);
        if (elevation != 0) {
    ...
    public Context getThemedContext() {
        if (this.mThemedContext == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0103R.attr.actionBarWidgetTheme, outValue, true);
