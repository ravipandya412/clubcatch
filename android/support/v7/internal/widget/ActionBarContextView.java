...
public class ActionBarContextView extends AbsActionBarView implements ViewPropertyAnimatorListener {
    ...
    public ActionBarContextView(Context context, AttributeSet attrs) {
        this(context, attrs, C0103R.attr.actionModeStyle);
    }

    public ActionBarContextView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0103R.styleable.ActionMode, defStyle, ANIMATE_IDLE);
        setBackgroundDrawable(a.getDrawable(C0103R.styleable.ActionMode_background));
        this.mTitleStyleRes = a.getResourceId(C0103R.styleable.ActionMode_titleTextStyle, ANIMATE_IDLE);
        this.mSubtitleStyleRes = a.getResourceId(C0103R.styleable.ActionMode_subtitleTextStyle, ANIMATE_IDLE);
        this.mContentHeight = a.getLayoutDimension(C0103R.styleable.ActionMode_height, (int) ANIMATE_IDLE);
        this.mSplitBackground = a.getDrawable(C0103R.styleable.ActionMode_backgroundSplit);
        this.mCloseItemLayout = a.getResourceId(C0103R.styleable.ActionMode_closeItemLayout, C0103R.layout.abc_action_mode_close_item_material);
        a.recycle();
    }
    ...
    private void initTitle() {
        ...
        int i2 = 8;
        if (this.mTitleLayout == null) {
            LayoutInflater.from(getContext()).inflate(C0103R.layout.abc_action_bar_title_item, this);
            this.mTitleLayout = (LinearLayout) getChildAt(getChildCount() - 1);
            this.mTitleView = (TextView) this.mTitleLayout.findViewById(C0103R.id.action_bar_title);
            this.mSubtitleView = (TextView) this.mTitleLayout.findViewById(C0103R.id.action_bar_subtitle);
    ...
    public void initForMode(ActionMode mode) {
        ...
        this.mClose.findViewById(C0103R.id.action_mode_close_button).setOnClickListener(new C01071(mode));
