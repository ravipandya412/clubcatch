...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent {
    ...
    class C08791 extends ViewPropertyAnimatorListenerAdapter {
        C08791() {
        }
    ...
    class C08802 extends ViewPropertyAnimatorListenerAdapter {
        C08802() {
        }
    ...
    static {
        ATTRS = new int[]{C0103R.attr.actionBarSize, 16842841};
    }
    ...
    public ActionBarOverlayLayout(Context context, AttributeSet attrs) {
        ...
        this.mTopAnimatorListener = new C08791();
        this.mBottomAnimatorListener = new C08802();
        this.mRemoveActionBarHideOffset = new C01083();
        this.mAddActionBarHideOffset = new C01094();
        init(context);
    ...
    void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C0103R.id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C0103R.id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C0103R.id.action_bar));
            this.mActionBarBottom = (ActionBarContainer) findViewById(C0103R.id.split_action_bar);
        }
    }
