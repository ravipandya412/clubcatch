...
class SpinnerCompat extends AbsSpinnerCompat implements OnClickListener {
    ...
    class C05611 extends ForwardingListener {
        final /* synthetic */ DropdownPopup val$popup;

        C05611(View x0, DropdownPopup dropdownPopup) {
    ...
    private class DropdownPopup extends ListPopupWindow implements SpinnerPopup {
        ...
        class C01181 implements OnItemClickListener {
            final /* synthetic */ SpinnerCompat val$this$0;

            C01181(SpinnerCompat spinnerCompat) {
        ...
        class C01203 implements OnDismissListener {
            final /* synthetic */ OnGlobalLayoutListener val$layoutListener;

            C01203(OnGlobalLayoutListener onGlobalLayoutListener) {
        ...
        public DropdownPopup(Context context, AttributeSet attrs, int defStyleAttr) {
            ...
            setOnItemClickListener(new C01181(SpinnerCompat.this));
        }
        ...
        public void show(int textDirection, int textAlignment) {
            ...
            if (!wasShowing) {
                ViewTreeObserver vto = SpinnerCompat.this.getViewTreeObserver();
                if (vto != null) {
                    OnGlobalLayoutListener layoutListener = new C01192();
                    vto.addOnGlobalLayoutListener(layoutListener);
                    setOnDismissListener(new C01203(layoutListener));
                }
            }
        }
    }
    ...
    SpinnerCompat(Context context, int mode) {
        this(context, null, C0103R.attr.spinnerStyle, mode);
    }

    SpinnerCompat(Context context, AttributeSet attrs) {
        this(context, attrs, C0103R.attr.spinnerStyle);
    }
    ...
    SpinnerCompat(Context context, AttributeSet attrs, int defStyle, int mode) {
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0103R.styleable.Spinner, defStyle, MODE_DIALOG);
        if (a.hasValue(C0103R.styleable.Spinner_android_background)) {
            setBackgroundDrawable(a.getDrawable(C0103R.styleable.Spinner_android_background));
        }
        if (mode == MODE_THEME) {
            mode = a.getInt(C0103R.styleable.Spinner_spinnerMode, MODE_DIALOG);
        }
        switch (mode) {
            case MODE_DIALOG /*0*/:
            ...
            case MODE_DROPDOWN /*1*/:
                ...
                this.mDropDownWidth = a.getLayoutDimension(C0103R.styleable.Spinner_android_dropDownWidth, -2);
                popup.setBackgroundDrawable(a.getDrawable(C0103R.styleable.Spinner_android_popupBackground));
                this.mPopup = popup;
                this.mForwardingListener = new C05611(this, popup);
                break;
        }
        this.mGravity = a.getInt(C0103R.styleable.Spinner_android_gravity, 17);
        this.mPopup.setPromptText(a.getString(C0103R.styleable.Spinner_prompt));
        this.mDisableChildrenWhenDisabled = a.getBoolean(C0103R.styleable.Spinner_disableChildrenWhenDisabled, false);
        a.recycle();
    ...
    public void onRestoreInstanceState(Parcelable state) {
        ...
        if (ss.showDropdown) {
            ...
            if (vto != null) {
                vto.addOnGlobalLayoutListener(new C01172());
            }
        }
    }
}
