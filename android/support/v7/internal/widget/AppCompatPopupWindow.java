...
public class AppCompatPopupWindow extends PopupWindow {
    ...
    static class C01151 implements OnScrollChangedListener {
        ...
        C01151(Field field, PopupWindow popupWindow, OnScrollChangedListener onScrollChangedListener) {
    ...
    public AppCompatPopupWindow(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0103R.styleable.PopupWindow, defStyleAttr, 0);
        this.mOverlapAnchor = a.getBoolean(C0103R.styleable.PopupWindow_overlapAnchor, false);
        setBackgroundDrawable(a.getDrawable(C0103R.styleable.PopupWindow_android_popupBackground));
        a.recycle();
    ...
    private static void wrapOnScrollChangedListener(PopupWindow popup) {
        try {
            ...
            fieldListener.set(popup, new C01151(fieldAnchor, popup, (OnScrollChangedListener) fieldListener.get(popup)));
        } catch (Exception e) {
