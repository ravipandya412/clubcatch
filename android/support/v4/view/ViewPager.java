...
public class ViewPager extends ViewGroup {
    ...
    public static class SavedState extends BaseSavedState {
        ...
        static class C05491 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C05491() {
            }
        ...
        static {
            CREATOR = ParcelableCompat.newCreator(new C05491());
        }
    ...
    public boolean executeKeyEvent(KeyEvent event) {
        ...
        switch (event.getKeyCode()) {
            ...
            case C0519R.styleable.Theme_popupWindowStyle /*61*/:
                if (VERSION.SDK_INT < 11) {
                    return DEBUG;
                }
