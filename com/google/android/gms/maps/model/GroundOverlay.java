...
public final class GroundOverlay {
    private final C0400c PR;

    public GroundOverlay(C0400c delegate) {
        this.PR = (C0400c) er.m725f(delegate);
    }
    ...
    public boolean equals(Object other) {
        ...
        try {
            return this.PR.m1170a(((GroundOverlay) other).PR);
