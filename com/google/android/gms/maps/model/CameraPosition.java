...
public final class CameraPosition implements SafeParcelable {
    ...
    CameraPosition(int versionCode, LatLng target, float zoom, float tilt, float bearing) {
        er.m723b((Object) target, (Object) "null camera target");
        boolean z = 0.0f <= tilt && tilt <= 90.0f;
        er.m724b(z, (Object) "Tilt needs to be between 0 and 90 inclusive");
        this.wj = versionCode;
        this.target = target;
        this.zoom = zoom;
        this.tilt = tilt + 0.0f;
    ...
    public String toString() {
        return ep.m717e(this).m716a("target", this.target).m716a("zoom", Float.valueOf(this.zoom)).m716a("tilt", Float.valueOf(this.tilt)).m716a("bearing", Float.valueOf(this.bearing)).toString();
    }

    public void writeToParcel(Parcel out, int flags) {
        if (C0388r.hc()) {
            C0389a.m1157a(this, out, flags);
        } else {
            CameraPositionCreator.m1145a(this, out, flags);
        }
    }
}
