...
public final class CameraUpdateFactory {
    ...
    static void m1119a(ICameraUpdateFactoryDelegate iCameraUpdateFactoryDelegate) {
        if (OJ == null) {
            OJ = (ICameraUpdateFactoryDelegate) er.m725f(iCameraUpdateFactoryDelegate);
        }
    }

    private static ICameraUpdateFactoryDelegate gL() {
        return (ICameraUpdateFactoryDelegate) er.m723b(OJ, (Object) "CameraUpdateFactory is not initialized");
    }
