...
public final class MediaInfo {
    ...
    MediaInfo(JSONObject json) throws JSONException {
        ...
        if (json.has("metadata")) {
            ...
            this.wN.m111b(jSONObject);
        }
        this.wO = dr.m616b(json.optDouble("duration", 0.0d));
        this.wP = json.optJSONObject("customData");
    }

    void m100a(MediaMetadata mediaMetadata) {
        this.wN = mediaMetadata;
    }

    void m101a(JSONObject jSONObject) {
        this.wP = jSONObject;
    }
    ...
    public JSONObject cT() {
        ...
        try {
            ...
            jSONObject.put("duration", dr.m617l(this.wO));
            if (this.wP != null) {
    ...
    public boolean equals(Object other) {
        ...
        if (this.wP != null && mediaInfo.wP != null && !fp.m776d(this.wP, mediaInfo.wP)) {
            return false;
        }
        if (!(dr.m615a(this.wK, mediaInfo.wK) && this.wL == mediaInfo.wL && dr.m615a(this.wM, mediaInfo.wM) && dr.m615a(this.wN, mediaInfo.wN) && this.wO == mediaInfo.wO)) {
            z = false;
        }
        return z;
    }
    ...
    void m102j(long j) throws IllegalArgumentException {
        if (j < 0) {
