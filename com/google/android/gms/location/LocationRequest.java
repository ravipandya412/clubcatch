...
public final class LocationRequest implements SafeParcelable {
    ...
    public LocationRequest() {
        ...
        this.Lf = ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED;
        this.Lg = 0.0f;
    }
    ...
    private static void m2130a(float f) {
        if (f < 0.0f) {
    ...
    private static void m2131r(long j) {
        if (j < 0) {
    ...
    public LocationRequest setSmallestDisplacement(float smallestDisplacementMeters) {
        m2130a(smallestDisplacementMeters);
    ...
    public String toString() {
        ...
        if (this.Lf != ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED) {
    ...
    public void writeToParcel(Parcel parcel, int flags) {
        LocationRequestCreator.m1117a(this, parcel, flags);
    }
}
