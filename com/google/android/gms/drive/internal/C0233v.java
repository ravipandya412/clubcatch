...
public interface C0233v extends IInterface {

    /* renamed from: com.google.android.gms.drive.internal.v.a */
    public static abstract class C0608a extends Binder implements C0233v {

        /* renamed from: com.google.android.gms.drive.internal.v.a.a */
        private static class C0607a implements C0233v {
            private IBinder ky;
            ...
            public void m1574a(OnContentsResponse onContentsResponse) throws RemoteException {
            ...
            public void m1575a(OnDownloadProgressResponse onDownloadProgressResponse) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.drive.internal.IDriveServiceCallbacks");
            ...
            public void m1576a(OnDriveIdResponse onDriveIdResponse) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.drive.internal.IDriveServiceCallbacks");
            ...
            public void m1577a(OnListEntriesResponse onListEntriesResponse) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.drive.internal.IDriveServiceCallbacks");
            ...
            public void m1578a(OnListParentsResponse onListParentsResponse) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.drive.internal.IDriveServiceCallbacks");
            ...
            public void m1579a(OnMetadataResponse onMetadataResponse) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.drive.internal.IDriveServiceCallbacks");
            ...
            public void m1580l(Status status) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.drive.internal.IDriveServiceCallbacks");
        ...
        public static C0233v m1581E(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.drive.internal.IDriveServiceCallbacks");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof C0233v)) ? new C0607a(iBinder) : (C0233v) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                case SpinnerCompat.MODE_DROPDOWN /*1*/:
                    ...
                    m322a(onDownloadProgressResponse);
    ...
    void m321a(OnContentsResponse onContentsResponse) throws RemoteException;

    void m322a(OnDownloadProgressResponse onDownloadProgressResponse) throws RemoteException;

    void m323a(OnDriveIdResponse onDriveIdResponse) throws RemoteException;

    void m324a(OnListEntriesResponse onListEntriesResponse) throws RemoteException;

    void m325a(OnListParentsResponse onListParentsResponse) throws RemoteException;

    void m326a(OnMetadataResponse onMetadataResponse) throws RemoteException;

    void m327l(Status status) throws RemoteException;
