...
public final class ParticipantEntity extends fy implements Participant {
    ...
    static final class C0629a extends C0260c {
        C0629a() {
        }

        public ParticipantEntity ao(Parcel parcel) {
            Object obj = 1;
            if (fy.m2719c(eg.dY()) || eg.ae(ParticipantEntity.class.getCanonicalName())) {
    ...
    static int m2962a(Participant participant) {
    ...
    static boolean m2963a(Participant participant, Object obj) {
    ...
    static String m2964b(Participant participant) {
        return ep.m717e(participant).m716a("Player", participant.getPlayer()).m716a("Status", Integer.valueOf(participant.getStatus())).m716a("ClientAddress", participant.ge()).m716a("ConnectedToRoom", Boolean.valueOf(participant.isConnectedToRoom())).m716a("DisplayName", participant.getDisplayName()).m716a("IconImage", participant.getIconImageUri()).m716a("IconImageUrl", participant.getIconImageUrl()).m716a("HiResImage", participant.getHiResImageUri()).m716a("HiResImageUrl", participant.getHiResImageUrl()).m716a("Capabilities", Integer.valueOf(participant.getCapabilities())).m716a("Result", participant.getResult()).toString();
    }
    ...
    public String toString() {
        return m2964b((Participant) this);
    }
