...
public final class GameEntity extends fy implements Game {
    ...
    static final class C0624a extends C0255a {
        C0624a() {
        }

        public GameEntity aj(Parcel parcel) {
            if (fy.m2719c(eg.dY()) || eg.ae(GameEntity.class.getCanonicalName())) {
    ...
    static boolean m2949a(Game game, Object obj) {
    ...
    static String m2950b(Game game) {
        return ep.m717e(game).m716a("ApplicationId", game.getApplicationId()).m716a("DisplayName", game.getDisplayName()).m716a("PrimaryCategory", game.getPrimaryCategory()).m716a("SecondaryCategory", game.getSecondaryCategory()).m716a("Description", game.getDescription()).m716a("DeveloperName", game.getDeveloperName()).m716a("IconImageUri", game.getIconImageUri()).m716a("IconImageUrl", game.getIconImageUrl()).m716a("HiResImageUri", game.getHiResImageUri()).m716a("HiResImageUrl", game.getHiResImageUrl()).m716a("FeaturedImageUri", game.getFeaturedImageUri()).m716a("FeaturedImageUrl", game.getFeaturedImageUrl()).m716a("PlayEnabledGame", Boolean.valueOf(game.isPlayEnabledGame())).m716a("InstanceInstalled", Boolean.valueOf(game.isInstanceInstalled())).m716a("InstancePackageName", game.getInstancePackageName()).m716a("AchievementTotalCount", Integer.valueOf(game.getAchievementTotalCount())).m716a("LeaderboardCount", Integer.valueOf(game.getLeaderboardCount())).m716a("RealTimeMultiplayerEnabled", Boolean.valueOf(game.isRealTimeMultiplayerEnabled())).m716a("TurnBasedMultiplayerEnabled", Boolean.valueOf(game.isTurnBasedMultiplayerEnabled())).toString();
    }
