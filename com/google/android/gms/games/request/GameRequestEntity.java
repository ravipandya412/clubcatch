...
public final class GameRequestEntity implements SafeParcelable, GameRequest {
    ...
    static int m2438a(GameRequest gameRequest) {
        return ep.hashCode(gameRequest.getGame(), gameRequest.fU(), gameRequest.getRequestId(), gameRequest.getSender(), m2440b(gameRequest), Integer.valueOf(gameRequest.getType()), Long.valueOf(gameRequest.getCreationTimestamp()), Long.valueOf(gameRequest.getExpirationTimestamp()));
    }

    static boolean m2439a(GameRequest gameRequest, Object obj) {
    ...
    static String m2441c(GameRequest gameRequest) {
        return ep.m717e(gameRequest).m716a("Game", gameRequest.getGame()).m716a("Sender", gameRequest.getSender()).m716a("Recipients", gameRequest.fU()).m716a("Data", gameRequest.getData()).m716a("RequestId", gameRequest.getRequestId()).m716a("Type", Integer.valueOf(gameRequest.getType())).m716a("CreationTimestamp", Long.valueOf(gameRequest.getCreationTimestamp())).m716a("ExpirationTimestamp", Long.valueOf(gameRequest.getExpirationTimestamp())).toString();
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        GameRequestEntityCreator.m374a(this, dest, flags);
    }
}
