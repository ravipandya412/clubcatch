...
public final class GooglePlayServicesUtil {
    ...
    private static int m122F(int i) {
        return i == -1 ? 2 : i;
    }

    private static byte[] m123Z(String str) {
        try {
    ...
    public static Dialog m124a(int i, Activity activity, int i2, OnCancelListener onCancelListener, int i3) {
        Builder message = new Builder(activity).setMessage(m130b(activity, i, i3));
        if (onCancelListener != null) {
            message.setOnCancelListener(onCancelListener);
        }
        OnClickListener efVar = new ef(activity, m125a(activity, i, i3), i2);
        CharSequence b = m129b(activity, i);
        if (b != null) {
        ...
        switch (i) {
            case SpinnerCompat.MODE_DIALOG /*0*/:
                return null;
            case SpinnerCompat.MODE_DROPDOWN /*1*/:
                return message.setTitle(C0143R.string.common_google_play_services_install_title).create();
            case DetectedActivity.ON_FOOT /*2*/:
                return message.setTitle(C0143R.string.common_google_play_services_update_title).create();
            case DetectedActivity.STILL /*3*/:
                return message.setTitle(C0143R.string.common_google_play_services_enable_title).create();
            case DetectedActivity.UNKNOWN /*4*/:
            case Participant.STATUS_UNRESPONSIVE /*6*/:
                return message.create();
            case DetectedActivity.TILTING /*5*/:
                Log.e("GooglePlayServicesUtil", "An invalid account was specified when connecting. Please provide a valid account.");
                return message.setTitle(C0143R.string.common_google_play_services_invalid_account_title).create();
            case C0519R.styleable.Toolbar_contentInsetRight /*7*/:
                Log.e("GooglePlayServicesUtil", "Network error occurred. Please retry request later.");
                return message.setTitle(C0143R.string.common_google_play_services_network_error_title).create();
            case TransportMediator.FLAG_KEY_MEDIA_PLAY_PAUSE /*8*/:
                Log.e("GooglePlayServicesUtil", "Internal error occurred. Please see logs for detailed information");
                return message.create();
            case C0519R.styleable.Toolbar_titleTextAppearance /*9*/:
                Log.e("GooglePlayServicesUtil", "Google Play services is invalid. Cannot recover.");
                return message.setTitle(C0143R.string.common_google_play_services_unsupported_title).create();
    ...
    public static Intent m125a(Context context, int i, int i2) {
        switch (i) {
            case SpinnerCompat.MODE_DROPDOWN /*1*/:
            case DetectedActivity.ON_FOOT /*2*/:
                return m121E(i2) ? m135u(context) ? ek.ai(GOOGLE_PLAY_SERVICES_PACKAGE) : ek.ah("com.google.android.apps.bazaar") : ek.ah(GOOGLE_PLAY_SERVICES_PACKAGE);
            case DetectedActivity.STILL /*3*/:
    ...
    public static boolean m126a(Resources resources) {
        if (resources == null) {
            return false;
        }
        return (fr.eJ() && ((resources.getConfiguration().screenLayout & 15) > 3)) || m131b(resources);
    }

    private static byte[] m127a(PackageInfo packageInfo, byte[]... bArr) {
        try {
    ...
    private static byte[][] m128a(byte[][]... bArr) {
        int i = 0;
    ...
    public static String m129b(Context context, int i) {
    ...
    public static String m130b(Context context, int i, int i2) {
        Resources resources = context.getResources();
        String string;
        switch (i) {
            case SpinnerCompat.MODE_DROPDOWN /*1*/:
                string = m126a(context.getResources()) ? resources.getString(C0143R.string.common_google_play_services_install_text_tablet) : resources.getString(C0143R.string.common_google_play_services_install_text_phone);
                return m121E(i2) ? string + " (via Bazaar)" : string;
            case DetectedActivity.ON_FOOT /*2*/:
                string = resources.getString(C0143R.string.common_google_play_services_update_text);
                return m121E(i2) ? string + " (via Bazaar)" : string;
            case DetectedActivity.STILL /*3*/:
                return resources.getString(C0143R.string.common_google_play_services_enable_text);
            case DetectedActivity.TILTING /*5*/:
            ...
            case C0519R.styleable.Toolbar_titleTextAppearance /*9*/:
                return resources.getString(C0143R.string.common_google_play_services_unsupported_text);
            case C0519R.styleable.Toolbar_titleMarginStart /*12*/:
                return resources.getString(C0143R.string.common_google_play_services_unsupported_date_text);
            default:
                return resources.getString(C0143R.string.common_google_play_services_unknown_issue);
        }
    }

    private static boolean m131b(Resources resources) {
        Configuration configuration = resources.getConfiguration();
        return fr.eL() && (configuration.screenLayout & 15) <= 3 && configuration.smallestScreenWidthDp >= 600;
    }

    public static boolean m132do() {
        return yS ? yT : "user".equals(Build.TYPE);
    }

    public static Dialog getErrorDialog(int errorCode, Activity activity, int requestCode) {
        return m124a(errorCode, activity, requestCode, null, -1);
    }

    public static Dialog getErrorDialog(int errorCode, Activity activity, int requestCode, OnCancelListener cancelListener) {
        return m124a(errorCode, activity, requestCode, cancelListener, -1);
    }

    public static PendingIntent getErrorPendingIntent(int errorCode, Context context, int requestCode) {
        Intent a = m125a(context, errorCode, -1);
    ...
    public static int isGooglePlayServicesAvailable(Context context) {
        ...
        try {
            ...
            try {
                if (m127a(packageManager.getPackageInfo(GOOGLE_PLAY_STORE_PACKAGE, 64), yL) == null) {
                    Log.w("GooglePlayServicesUtil", "Google Play Store signature invalid.");
                    return 9;
                }
                if (m127a(packageInfo, m127a(packageManager.getPackageInfo(GOOGLE_PLAY_STORE_PACKAGE, 64), yL)) == null) {
    ...
    public static void m133s(Context context) throws GooglePlayServicesRepairableException, GooglePlayServicesNotAvailableException {
        int isGooglePlayServicesAvailable = isGooglePlayServicesAvailable(context);
        if (isGooglePlayServicesAvailable != 0) {
            Intent a = m125a(context, isGooglePlayServicesAvailable, -1);
    ...
    public static boolean showErrorDialogFragment(int errorCode, Activity activity, int requestCode, OnCancelListener cancelListener) {
        ...
        if (z) {
            C0897b.m2380a(errorDialog, cancelListener).show(((FragmentActivity) activity).getSupportFragmentManager(), GMS_ERROR_DIALOG);
        } else if (fr.eJ()) {
    ...
    private static void m134t(Context context) {
    ...
    private static boolean m135u(Context context) {
        if (yS) {
            return yU;
        }
        try {
            return m127a(context.getPackageManager().getPackageInfo("com.google.android.apps.bazaar", 64), yR) != null;
        } catch (NameNotFoundException e) {
            return false;
        }
    }
