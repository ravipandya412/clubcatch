...
class aw implements bl {
    ...
    private InputStream m2253a(HttpURLConnection httpURLConnection) throws IOException {
    ...
    private void m2254b(HttpURLConnection httpURLConnection) {
