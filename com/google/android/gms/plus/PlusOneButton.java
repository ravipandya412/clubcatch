...
import com.google.android.gms.plus.internal.C0415g;
...
public final class PlusOneButton extends FrameLayout {
    ...
    protected static int getAnnotation(Context context, AttributeSet attrs) {
        String a = eu.m733a("http://schemas.android.com/apk/lib/com.google.android.gms.plus", "annotation", context, attrs, true, false, "PlusOneButton");
    ...
    protected static int getSize(Context context, AttributeSet attrs) {
        String a = eu.m733a("http://schemas.android.com/apk/lib/com.google.android.gms.plus", "size", context, attrs, true, false, "PlusOneButton");
    ...
    private void m1181v(Context context) {
        if (this.QV != null) {
            removeView(this.QV);
        }
        this.QV = C0415g.m1209a(context, this.mSize, this.QW, this.pS, this.QX);
        setOnPlusOneClickListener(this.QY);
        addView(this.QV);
    }

    public void initialize(String url, int activityRequestCode) {
        er.m721a(getContext() instanceof Activity, "To use this method, the PlusOneButton must be placed in an Activity. Use initialize(String, OnPlusOneClickListener).");
        this.pS = url;
