...
import com.google.android.gms.internal.C0993v.C0365a;
...
public final class cp {
    ...
    public static Bundle m517a(C0365a c0365a, String str, Context context) {
        Bundle bundle;
        synchronized (op) {
            bundle = new Bundle();
            bundle.putBundle("app", pv.m521b(str, context));
    ...
    public static void m518a(co coVar) {
        synchronized (op) {
            px.add(coVar);
        }
    }

    public static void m519a(C0365a c0365a) {
        synchronized (op) {
            px.addAll(c0365a.ah());
        }
    }

    public static void m520a(String str, cr crVar) {
        synchronized (op) {
            py.put(str, crVar);
        }
    }
