...
public interface af extends IInterface {
    ...
    public static abstract class C0633a extends Binder implements af {

        /* renamed from: com.google.android.gms.internal.af.a.a */
        private static class C0632a implements af {
            private IBinder ky;
        ...
        public static af m1636e(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.ads.internal.client.IAdListener");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof af)) ? new C0632a(iBinder) : (af) queryLocalInterface;
        }
