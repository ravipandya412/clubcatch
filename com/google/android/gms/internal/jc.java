...
import com.google.android.gms.internal.ir.C0351e;
...
public final class jc extends C0201b implements Person {
    ...
    public Image getImage() {
        return new C0985c(getString("image"));
    }
    ...
    public int getObjectType() {
        return C0351e.aT(getString("objectType"));
    }
    ...
    public Person it() {
        return new ir(getDisplayName(), getId(), (C0985c) getImage(), getObjectType(), getUrl());
    }
}
