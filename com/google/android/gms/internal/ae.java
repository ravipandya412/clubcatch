...
public final class ae {
    ...
    public ae(Context context, AttributeSet attributeSet) {
        int i = 1;
        TypedArray obtainAttributes = context.getResources().obtainAttributes(attributeSet, C0143R.styleable.AdsAttrs);
        ...
        if (i2 != 0 && r1 == 0) {
            this.lr = m388f(string);
        } else if (i2 == 0 && r1 != 0) {
            this.lr = m388f(string2);
        } else if (i2 == 0 || r1 == 0) {
    ...
    private static AdSize[] m388f(String str) {
