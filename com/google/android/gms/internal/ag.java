...
public interface ag extends IInterface {
    ...
    public static abstract class C0635a extends Binder implements ag {

        /* renamed from: com.google.android.gms.internal.ag.a.a */
        private static class C0634a implements ag {
            private IBinder ky;
            ...
            public C0251b m1637P() throws RemoteException {
            ...
            public ab m1638Q() throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.ads.internal.client.IAdManager");
                    ...
                    obtain2.readException();
                    ab b = obtain2.readInt() != 0 ? ab.CREATOR.m386b(obtain2) : null;
                    obtain2.recycle();
                    obtain.recycle();
                    return b;
                } catch (Throwable th) {
            ...
            public void m1639Z() throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.ads.internal.client.IAdManager");
            ...
            public void m1640a(ab abVar) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.ads.internal.client.IAdManager");
            ...
            public void m1641a(af afVar) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.ads.internal.client.IAdManager");
            ...
            public void m1642a(ai aiVar) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.ads.internal.client.IAdManager");
            ...
            public boolean m1643a(C0739z c0739z) throws RemoteException {
                boolean z = true;
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
        ...
        public static ag m1644f(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.ads.internal.client.IAdManager");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof ag)) ? new C0634a(iBinder) : (ag) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case C0519R.styleable.Toolbar_contentInsetRight /*7*/:
                    data.enforceInterface("com.google.android.gms.ads.internal.client.IAdManager");
                    m394a(C0633a.m1636e(data.readStrongBinder()));
                    reply.writeNoException();
                    return true;
                case TransportMediator.FLAG_KEY_MEDIA_PLAY_PAUSE /*8*/:
                    data.enforceInterface("com.google.android.gms.ads.internal.client.IAdManager");
                    m395a(C0639a.m1647h(data.readStrongBinder()));
                    reply.writeNoException();
                    return true;
    ...
    C0251b m390P() throws RemoteException;

    ab m391Q() throws RemoteException;

    void m392Z() throws RemoteException;

    void m393a(ab abVar) throws RemoteException;

    void m394a(af afVar) throws RemoteException;

    void m395a(ai aiVar) throws RemoteException;

    boolean m396a(C0739z c0739z) throws RemoteException;
