...
public final class ay {
    ...
    public ay(String str) throws JSONException {
        ...
        if (da.m565n(2)) {
            da.m569v("Mediation Response JSON: " + jSONObject.toString(2));
        }
        ...
        if (optJSONObject != null) {
            ...
            this.mt = bd.m436a(optJSONObject, "click_urls");
            this.mu = bd.m436a(optJSONObject, "imp_urls");
            this.mv = bd.m436a(optJSONObject, "nofill_urls");
    ...
    private boolean m429a(ax axVar) {
