...
public final class eb {
    public static Bitmap m659a(Bitmap bitmap) {
        if (bitmap == null) {
            return null;
        }
    ...
    private static Bitmap m660a(Drawable drawable) {
        if (drawable == null) {
            return null;
        }
    ...
    public static Drawable m661a(Resources resources, Drawable drawable) {
        return new BitmapDrawable(resources, m659a(m660a(drawable)));
    }
}
