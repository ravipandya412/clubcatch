...
public final class ab implements SafeParcelable {
    ...
    public ab(Context context, AdSize[] adSizeArr) {
        ...
        if (i4 != 0) {
            this.widthPixels = m1633a(displayMetrics);
            i = (int) (((float) this.widthPixels) / displayMetrics.density);
        } else {
            i2 = this.width;
            this.widthPixels = cz.m557a(displayMetrics, this.width);
            i = i2;
        }
        i2 = i5 != 0 ? m1635c(displayMetrics) : this.height;
        this.heightPixels = cz.m557a(displayMetrics, i2);
        if (i4 == 0 && i5 == 0) {
    ...
    public static int m1633a(DisplayMetrics displayMetrics) {
        return displayMetrics.widthPixels;
    }

    public static int m1634b(DisplayMetrics displayMetrics) {
        return (int) (((float) m1635c(displayMetrics)) * displayMetrics.density);
    }

    private static int m1635c(DisplayMetrics displayMetrics) {
        int i = (int) (((float) displayMetrics.heightPixels) / displayMetrics.density);
        return i <= 400 ? 32 : i <= 720 ? 50 : 90;
    }

    public AdSize ai() {
        return C0145a.m21a(this.width, this.height, this.ln);
    }
