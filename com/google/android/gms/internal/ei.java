...
public final class ei {
    ...
    final class C0331a extends Handler {
        final /* synthetic */ ei BP;

        public C0331a(ei eiVar, Looper looper) {
            this.BP = eiVar;
            super(looper);
        }
    ...
    public ei(Context context, Looper looper, C0332b c0332b) {
        ...
        this.BJ = c0332b;
        this.mHandler = new C0331a(this, looper);
    }

    public void m670P(int i) {
    ...
    public void m671a(ConnectionResult connectionResult) {
        this.mHandler.removeMessages(1);
    ...
    public void m672b(Bundle bundle) {
        boolean z = true;
        synchronized (this.BK) {
            er.m726v(!this.BM);
            this.mHandler.removeMessages(1);
