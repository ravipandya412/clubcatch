...
public final class kh {
    ...
    public static boolean m1074b(jy jyVar, int i) throws IOException {
        return jyVar.cv(i);
    }

    public static final int m1075c(jy jyVar, int i) throws IOException {
        int i2 = 1;
    ...
    static int m1076i(int i, int i2) {
        return (i << 3) | i2;
    }
}
