...
public final class cm {
    ...
    public cm(Context context) {
        ...
        this.oN = m510a(packageManager, "geo:0,0?q=donuts") != null;
        if (m510a(packageManager, "http://www.google.com") == null) {
            z = false;
        }
        this.oO = z;
        ...
        this.oV = m511a(packageManager);
        this.oW = audioManager.getStreamVolume(3);
        this.oX = m509a(context, connectivityManager, packageManager);
    ...
    private static int m509a(Context context, ConnectivityManager connectivityManager, PackageManager packageManager) {
        if (!cv.m537a(packageManager, context.getPackageName(), "android.permission.ACCESS_NETWORK_STATE")) {
            return -2;
        }
    ...
    private static ResolveInfo m510a(PackageManager packageManager, String str) {
        return packageManager.resolveActivity(new Intent("android.intent.action.VIEW", Uri.parse(str)), Cast.MAX_MESSAGE_LENGTH);
    }

    private static String m511a(PackageManager packageManager) {
        String str = null;
        ResolveInfo a = m510a(packageManager, "market://details?id=com.google.android.gms.ads");
        if (a != null) {
