...
class ak {
    ...
    public static Map<String, String> m57I(String str) {
    ...
    public static String m58J(String str) {
    ...
    public static double m59a(String str, double d) {
        if (str != null) {
            try {
    ...
    static String m60a(Locale locale) {
    ...
    public static void m61a(Map<String, String> map, String str, String str2) {
        if (!map.containsKey(str)) {
            map.put(str, str2);
        }
    }

    public static boolean m62d(String str, boolean z) {
